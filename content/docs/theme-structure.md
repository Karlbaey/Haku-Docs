...
lastmod: 2026-05-01T01:25:00+08:00
weight: 20
---
...
| `content/docs/*.md` | 具体文档页面，首页目录和侧栏都会自动收录。 |
...
- `content/docs/getting-started.md` 这类普通 Markdown 页面会生成 `/docs/getting-started/`。
...
1. 先在 `content/docs/` 新增页面，确认内容流转没问题。
